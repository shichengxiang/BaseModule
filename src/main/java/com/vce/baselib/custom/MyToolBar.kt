...
class MyToolBar :Toolbar {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr){
        ...
        val resBackIcon = typedArray.getInt(R.styleable.MyToolBar_tb_start_icon, R.drawable.ic_back)
...
//        typedArray.getStringOrThrow(R.styleable.MyToolBar_tb_end_textview1_txt)
        ...
        mBack?.setBackgroundResource(resBackIcon)
        ...
        if(txt1.isNullOrEmpty() && end1Icon==null){
            ...
            if(!txt1.isNullOrEmpty()) mRight1?.text = txt1
            if(end1Icon!=null){
        ...
        if(txt2.isNullOrEmpty() && end2Icon==null){
            ...
            if(!txt2.isNullOrEmpty()) mRight2?.text =txt2
            if(end2Icon!=null){
